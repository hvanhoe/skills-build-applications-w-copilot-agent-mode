...
2. Setup backend python venv and create an octofit-tracker/backend/requirements.txt file
...
6. Setup the octofit-tracker/frontend directory to store the react app with no subdirectories
